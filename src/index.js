/**
 * EDtunnel - A Cloudflare Worker-based VLESS Fumidai with WebSocket Transport
 *
 ...
 * - fumidai/      : Fumidai implementations (SOCKS5, TCP, stream)
...
export default {
	 ...
	 * @param {{UserId: string, FUMIDAI: string, SOCKS5: string, SOCKS5_RELAY: string}} env - Environment variables
